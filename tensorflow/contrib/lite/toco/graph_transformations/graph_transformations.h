...
DECLARE_GRAPH_TRANSFORMATION(IdentifyGruCell)
...
DECLARE_GRAPH_TRANSFORMATION(PartialQuantize)
...
DECLARE_GRAPH_TRANSFORMATION(ResolveTransposeConvShape)
DECLARE_GRAPH_TRANSFORMATION(ResolveConstantFakeQuant)
DECLARE_GRAPH_TRANSFORMATION(ResolveConstantDequantize)
DECLARE_GRAPH_TRANSFORMATION(ResolveConstantQuantize)
...
DECLARE_GRAPH_TRANSFORMATION(ResolveLeakyRelu)
